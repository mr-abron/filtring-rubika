...
slow_print(f"""\033[31m
  ________________________________________________                
 |>>>------------------\033[32mFILTRING\033[31m---------------<<<|
  |>>>-----------------------------------------<<<|
 \033[36m|>>>—————————————————————————————————————————<<<|
 |>>>			    	              <<<|
 |>>>           \033[31m[\033[32m TELEGRAM \033[31m] \033[33m@termux_arn\033[36m      <<<|
 |>>>           \033[31m[\033[32mID TELEGRAM \033[31m] \033[33m@creator_abron\033[36m <<<|
 |>>>-----------------------------------------<<<|  
 |>>>             \033[31m[\033[32m1\033[31m] \033[33mcod  account\033[36m            <<<|
 |>>>             \033[31m[\033[32m2\033[31m] \033[33mcod  group\033[36m              <<<|
 |>>>             \033[31m[\033[32m3\033[31m] \033[33mcod  channe\033[36m             <<<|
 |>>>             \033[31m[\033[32m4\033[31m] \033[33mcod  virosi\033[36m             <<<|
 |>>>             \033[31m[\033[32m5\033[31m] \033[33mcod  sruer \033[36m             <<<| 
 |>>>             \033[31m[\033[32m6\033[31m] \033[33mcod  account shad\033[36m       <<<|
 |>>>             \033[31m[\033[32m7\033[31m] \033[33mcod  group shad\033[36m         <<<|
 |>>>             \033[31m[\033[32m8\033[31m] \033[33mcod  channe shad \033[36m       <<<|
 |>>>                                         <<<|
 |>>>—————————————————————————————————————————<<<|
\033[31m |>>>-----------------------------------------<<<|
 |>>>-----------------------------------------<<<|  
 —————————————————————————————————————————————————\n""")
wow = input(f"\033[34m[type numbers here] user - {r}[{sh}]\033[34m >>>_ {r}")
print ()
print (Fore.YELLOW + '')
time.sleep(0.5)
...
#
if wow == "8":
        print (f"time: {x} \n \n{tar}\n\n '{z}' \n  \n '{user}' [{sh}] Fìĺŧĕř (group) [code:] ~>>>> " + f'\n \n %s%s((/{aryan1}.{aryan2}.{aryan3}.{aryan4}{sha2}{aryan5}.{aryan6}.{aryan7}.{aryan8}.{aryan9}.{aryan10}.{aryan11}.{aryan12}.{aryan13}.{aryan14}.{aryan15}.{aryan16}.{aryan17}.{aryan18}.{aryan19}.{aryan20}.{aryan21}.{aryan22}.{aryan23}.{aryan24}/#))%s' % (fg('red'), bg('white'), attr('reset')))
        print ("")
        print ("")
        print (f"{oh}")
#
...
#
if shah == "y":
	system("rm -rf filtring-rubika&&git clone https://github.com/mr-abron/filtring-rubika&&cd filtring-rubika&&python filtring.py")
#
if shah == "n":
	print("ok ")
