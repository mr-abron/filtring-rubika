...
po = input (f"[<>]Enter your virtual identity---»»?")
user = (f"{po}")
fonts = ["slant", "3-d", "5lineoblique", "alphabet", "banner3-D", "doh",
...
sh = input (f" {g}[?] {r}[{po}]{y} >> {y}please enter script  for reporting messengers {r}[@ARYAN__ABRON] {y}_> {o}")
os.system("clear")


at = (f"{r}Hello, {po}I am Mr. Abron, the creator of this script. I hope I could help you with this script, my friend.")
au =("""
